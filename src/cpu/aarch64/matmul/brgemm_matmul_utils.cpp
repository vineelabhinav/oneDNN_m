...
void init_scratchpad(memory_tracking::registrar_t &scratchpad,
    ...
    if (bgmmc.use_buffer_b) {
        std::cout<<"brgemm_matmul_utils.cpp:1238: scratchpad book"<<"\n";
        std::cout<<"bgmmc.nthr: "<<bgmmc.nthr<<"\n";
        std::cout<<" bgmmc.buffer_b_per_thread_sz: "<< bgmmc.buffer_b_per_thread_sz<<"\n";
        std::cout<<"default_data_align: "<<default_data_align<<"\n";
        std::cout<<"key_brgemm_primitive_buffer_b: "<<key_brgemm_primitive_buffer_b<<"\n";
